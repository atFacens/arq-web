...
public class UserAppController {
    ...
    @PostMapping
    public ResponseEntity<UserApp> createUser(@Valid @RequestBody UserApp user) {
    ...
    public ResponseEntity<UserApp> getUserApp(@PathVariable String email) {
        UserApp user = service.getByEmail(email);
